            ...
            <section class="bg-transparent dark:bg-gray-900">
                <div class="gap-16 items-center py-8 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-16 lg:px-6">
                    <div class="font-light text-gray-500 sm:text-lg dark:text-gray-400">
                        <h2 class="mb-4 text-4xl tracking-widest font-extrabold text-gray-900 uppercase">Quote of the year</h2>
                        <blockquote>
                            <p class="mb-4 tracking-wide uppercase italic">"Muhammad Ali punya kecepatan dan saya punya kekuatan, tetapi dia(alex) punya keduanya dia adalah legenda."</p>
                        </blockquote>
                        <span class="font-bold uppercase tracking-wide">- Mike Tyson</span>
                    </div>
                    <div class="grid grid-cols-2 gap-4 mt-8">
                        <img class="w-full rounded-lg" src="https://source.unsplash.com/570x792?mma">
                        <img class="mt-4 w-full lg:mt-10 rounded-lg" src="https://source.unsplash.com/570x792?alex">
                    </div>
                </div>
            </section>
